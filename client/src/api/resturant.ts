...
export const createMenuItem = async (args: Core.I.MenuItemInfo) => (await Utils.server.makeRequest.post<Core.I.ServerRequest<Core.I.MenuItemRecord>>(`/resturants/menuItems`, args)).data.records